...
$out = mysqli_real_escape_string($con, $_POST['out_branch']);
$quantity_out = mysqli_real_escape_string($con, $_POST['quantity_out']);
$available = mysqli_real_escape_string($con, $_POST['quantity']);

//Inserting data into the database
$sql = "INSERT INTO stocks (supplier, product, quantity, price, damage, out_branch, quantity_out, available) VALUES ('$supplier', '$product', '$quantity', '$price', '$damage', '$out', '$quantity_out', '$available')";
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Adding product</h6>
            </div>
            <div class="card-body">
              ...
              <div class="form-group">
                <div class="col-sm-6 mb-3 mb-sm-0">
                 ...
                 <input type="text" name="supplier" class="form-control" placeholder="Product Supplier" id="supplier" required>
              </div>
            </div>
            ...
            <input type="hidden" name="damage" value="-">
              <input type="hidden" name="out_branch" value="-">
              <input type="hidden" name="quantity_out" value="-">
              <input type="hidden" name="available" value="as qty">
